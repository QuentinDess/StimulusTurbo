...
return [
    ...
    'product_admin_index' => [[], ['_controller' => 'App\\Controller\\ProductAdminController::index'], [], [['text', '/admin/product/']], [], []],
    'product_admin_new' => [[], ['_controller' => 'App\\Controller\\ProductAdminController::new'], [], [['text', '/admin/product/new']], [], []],
    'product_admin_show' => [['id'], ['_controller' => 'App\\Controller\\ProductAdminController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/product']], [], []],
    'product_admin_edit' => [['id'], ['_controller' => 'App\\Controller\\ProductAdminController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/admin/product']], [], []],
    'product_admin_delete' => [['id'], ['_controller' => 'App\\Controller\\ProductAdminController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/product']], [], []],
