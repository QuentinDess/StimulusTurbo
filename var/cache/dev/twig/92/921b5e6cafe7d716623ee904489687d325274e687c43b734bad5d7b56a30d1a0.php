...
/* cart/cart.html.twig */
class __TwigTemplate_449f169ba5eb7ee453a6c96b3aeefb88827ff38a6aeba12bc652cdce80d1340f extends Template
{
    private $source;
    private $macros = [];
...
$context["item"], "color", [], "any", false, false, false, 48)) ? (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "color", [], "any", false, false, false, 48), "id", [], "any", false, false, false, 48)) : (null))]), "html", null, true);
        ...
        echo "
                        ";
        // line 66
        if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["cart"]) || array_key_exists("cart", $context) ? $context["cart"] : (function () { throw new RuntimeError('Variable "cart" does not exist.', 66, $this->source); })()), "items", [], "any", false, false, false, 66)), 0))) {
            // line 67
            echo "                        <div class=\"p-3\">
                            Total: <strong>";
            // line 68
        ...
        echo "                    </div>
                    ...
                    ";
        // line 73
        if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["cart"]) || array_key_exists("cart", $context) ? $context["cart"] : (function () { throw new RuntimeError('Variable "cart" does not exist.', 73, $this->source); })()), "items", [], "any", false, false, false, 73)), 0))) {
            // line 74
            echo "                    <div>
                        <a href=\"";
            // line 75
